...
{/* heading */}
        <div className='text-center mb-6'>
            <h1 className='text-3xl sm:text-5xl md:text-6xl 2xl:text-7xl font-semibold mx-auto leading-[1.2]'>Create amazing content
                <br/>
                 with 
...
{/* buttons */}
        <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
            ...
            <button className='bg-white px-10 py-3 rounded-lg border border-gray-300 hover:scale-95 transition cursor-pointer'>Watch demo</button>
        </div>
